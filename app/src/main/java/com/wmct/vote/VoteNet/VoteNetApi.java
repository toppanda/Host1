...
public class VoteNetApi {
    ...
    private static final String TESPAI = "http://www.tngou.net/tnfs/api/news";
...
//    }
     ...
     *提交投票
     */
    public static void voteSubmit( String subTicket, Request.RequestListener<JSONObject> listener) {
